    ...
    <div className="min-h-screen bg-[#050507] text-white">
      <div className="border-b border-white/5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/manufacturer/dashboard" className="text-[#eb9728] text-sm font-bold flex items-center gap-2 hover:underline">
            <span className="material-symbols-outlined text-[16px]">arrow_back</span> Dashboard
          </Link>
          <span className="text-xs font-bold uppercase tracking-widest text-white/30">Manufacturer Security</span>
        </div>
      </div>
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-white/50 max-w-xl">
                Protect your manufacturer account with an extra layer of security. Once configured, you&apos;ll be required to enter both your password and an authentication code from your email to sign in.
              </p>
            </div>
