...
export default function ProductDetailPage() {
  ...
  const [mediaView, setMediaView] = useState("images"); // "images" or "3d"
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`px-3 py-1 text-[9px] font-black uppercase tracking-widest rounded-full border ${STATUS_STYLES[product.status]}`}
                >
                  {product.status.replace("_", " ")}
                </span>
              </div>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mt-1">
                Product Console v2.0
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white/[0.03] rounded-[2.5rem] border-2 border-purple-500/20 p-8">
                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-400 mb-5">
                  Product Narrative
                </h3>
              ...
              <div className="bg-white/[0.03] rounded-[2.5rem] border-2 border-purple-500/20 p-8">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    {
                      label: "Net Weight",
                      value: specs.weight ? `${specs.weight} kg` : null,
                    },
                    {
                  ...
                  <div className="mt-8 pt-8 border-t border-white/5">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {specs.color.map((c) => (
                        <span
                          key={c}
                          className="px-4 py-2 bg-white/5 border border-white/10 text-[9px] font-black uppercase tracking-widest rounded-xl text-white/60"
                        >
                          {c}
                        </span>
                      ))}
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-2">
                  {[
                    {
                      id: "all",
                      label: `All (${qaCounts.all})`,
                      color: "bg-white/5 border-white/10 text-white/40",
                    },
                    {
                      id: "pending",
                      label: `Pending (${qaCounts.pending})`,
                      color:
                        "bg-amber-500/10 border-amber-500/20 text-amber-400",
                    },
                    {
                      id: "answered",
                      label: `Answered (${qaCounts.answered})`,
                      color:
              ...
              {qaLoading ? (
                ...
                <div className="py-20 text-center border-2 border-dashed border-white/5 rounded-[2rem] bg-white/[0.01]">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20">
                    No Active Inquiries found in this view
                  </p>
                </div>
              ) : (
                <div className="space-y-6">
                  {visibleQaItems.map((qa) => (
                    <article
                      key={qa._id}
                      className={`p-8 rounded-[2rem] border-2 transition-all ${qa.isVisible ? "bg-white/[0.02] border-white/5" : "bg-red-500/5 border-red-500/10 opacity-60"}`}
                    >
                        ...
                        <div className="mt-8 space-y-4">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase tracking-widest text-white/10">
                              Chars: {String(answerDrafts[qa._id] || "").length}{" "}
                              / 1200
                            </span>
                            <button
          ...
          <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4 pt-8 border-t border-white/5">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-[11px] font-black uppercase tracking-widest ${item.color}`}
                    >
                      {item.value}
                    </span>
                  </div>
            ...
            <div className="bg-white/[0.03] rounded-[2.5rem] border-2 border-purple-500/20 p-8 shadow-xl">
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-400 mb-8">
                Performance Metrics
              </h3>
              <div className="space-y-6">
                {[
