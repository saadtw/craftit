              ...
              {step === 4 && (
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="border-l-4 border-purple-600 pl-6">
                    ...
                    <p className="text-sm text-white/40 mt-1">
                      Upload high-quality images and a 3D model for your
                      product.
                    </p>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {form.images.map((img, i) => (
                          <div
                            key={i}
                            className="group relative aspect-square rounded-2xl overflow-hidden border-2 border-purple-500/20 bg-white/5"
                          >
                            <Image
                              src={img.url}
                              alt=""
              ...
              {step === 5 && (
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="border-l-4 border-purple-600 pl-6">
                    ...
                    <p className="text-sm text-white/40 mt-1">
                      Optimize how your product appears in search results and
                      within the platform.
                    </p>
                  </div>
