...
export default function PlaceProductOrderPage() {
  ...
  if (status === "loading" || loading) {
    return <GlobalLoader fullScreen text="Preparing your order..." />;
  }
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <Link
                ...
                className="mb-4 inline-flex items-center gap-1.5 text-sm font-semibold text-white/45 hover:text-[#eb9728]"
              >
              ...
              <p className="mt-2 text-sm text-white/50">
                Confirm quantity, delivery details, and payment method before
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-5 lg:col-span-2">
            <section className="rounded-[24px] border border-white/8 bg-[#0c0c11] p-5 sm:p-6">
              ...
              <label className="mb-2 block text-xs font-bold uppercase tracking-[0.18em] text-white/35">
                Quantity (units)
              </label>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button
                  onClick={() =>
                    setForm((f) => ({
                      ...f,
                      quantity: String(
                        Math.max(product.moq, parseInt(f.quantity || 0) - 1),
                      ),
                    }))
                  }
                  className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-xl font-black text-white/70 hover:border-[#eb9728]/40 hover:text-[#eb9728]"
                >
                  −
                </button>
                ...
                <input
                  ...
                  min={product.moq}
                  className="h-11 w-28 rounded-xl border border-white/10 bg-white/[0.03] px-3 text-center text-sm font-bold text-white focus:border-[#eb9728] focus:outline-none"
                />
              ...
              {savedAddresses.length > 0 && (
                <div className="mb-4">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#101017] px-4 py-3 text-sm text-white/80 focus:border-[#eb9728] focus:outline-none"
                  >
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 rounded-2xl border p-4 text-xs font-bold transition-all ${
                      form.paymentMethod === opt.value
                        ? "border-[#eb9728]/50 bg-[#eb9728]/10 text-[#eb9728]"
          ...
          <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
            ...
            <section className="rounded-[24px] border border-white/8 bg-[#0c0c11] p-5">
              ...
              {product.leadTime && (
                <div className="mb-4 flex items-center gap-2 rounded-xl border border-[#eb9728]/20 bg-[#eb9728]/10 px-3 py-2 text-xs text-[#eb9728]">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#eb9728] py-3 text-sm font-bold text-white transition-colors hover:bg-amber-500 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {submitting ? (
                  <>
...
function FormField({ label, value, onChange, placeholder, required }) {
  return (
    <div>
      <label className="mb-1.5 block text-xs font-bold uppercase tracking-[0.14em] text-white/35">
        {label}
      </label>
      <input
        type="text"
        ...
        required={required}
        className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-[#eb9728] focus:outline-none"
      />
    </div>
  );
}
