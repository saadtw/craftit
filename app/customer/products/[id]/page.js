          ...
          <div>
            <div className="overflow-hidden rounded-[28px] border border-white/8 bg-[#0c0c11]">
              ...
              {mediaView === "3d" && product.model3D?.url ? (
                ...
                <div className="relative aspect-square overflow-hidden bg-[#0c0c11] group">
                  {product.images?.[activeImage]?.url ? (
                    <>
                      ...
                      {product.images.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/60 backdrop-blur-md rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-black/80 hover:scale-110 disabled:opacity-30 disabled:hover:scale-100 transition-all z-20"
                          >
                          ...
                          <button
                            ...
                            className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/60 backdrop-blur-md rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-black/80 hover:scale-110 disabled:opacity-30 disabled:hover:scale-100 transition-all z-20"
                          >
                      ...
                      {product.images?.length > 0 && (
                        <div className="absolute bottom-4 right-4 px-3 py-1.5 bg-black/60 backdrop-blur-md rounded-xl border border-white/10 text-[9px] font-black uppercase tracking-widest text-white/60 z-20 pointer-events-none">
