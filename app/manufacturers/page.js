    ...
    <div className="min-h-screen bg-[#050507] text-white">
      ...
      <main className="mx-auto max-w-7xl px-5 py-10">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-[28px] border border-white/8 bg-[#0c0c11] px-6 py-20 text-center">
            <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-3xl border border-[#eb9728]/20 bg-[#eb9728]/10 text-[#eb9728]">
              <svg
                className="h-10 w-10"
                fill="none"
                stroke="currentColor"
            ...
            {(search || capability) && (
              <button
                ...
                className="mt-4 text-sm font-bold text-[#eb9728] underline underline-offset-4"
              >
                Clear filters
              </button>
            )}
