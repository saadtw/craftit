...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-[#060111] p-4 md:p-8 font-sans relative overflow-hidden text-white">
      ...
      <div className="absolute right-[-25%] bottom-[-12%] w-[650px] h-[650px] z-1 pointer-events-none opacity-20 hidden lg:block transition-all duration-700">
        <Image
          src={sellerImg}
          alt="Seller"
          fill
      ...
      <div className="relative z-10 w-full max-w-4xl py-6 -mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <Link href="/auth/signup/customer" className="group">
            {/* MODIFIED: Reduced min-height from 350px to 300px and padding from p-8 to p-6 */}
            <div className="h-full min-h-[300px] relative overflow-hidden rounded-4xl border border-white/5 bg-white/2 backdrop-blur-3xl p-6 flex flex-col items-center text-center transition-all duration-500 hover:border-purple-500/50 hover:bg-white/4 hover:shadow-[0_0_40px_rgba(168,85,247,0.15)]">
              <div className="mb-6 relative flex items-center justify-center">
                ...
                {/* MODIFIED: Reduced Icon size slightly from w-24 to w-20 */}
