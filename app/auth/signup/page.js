...
export default function SignupPage() {
  ...
  return (
    // Changed h-screen to min-h-screen and added flex-col to allow proper spacing
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-[#060111] p-4 md:p-8 font-sans relative overflow-hidden text-white">
      ...
      <div className="absolute left-[-18%] top-[2%] w-[650px] h-[650px] z-1 pointer-events-none opacity-30 hidden lg:block transition-all duration-700">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#060111] via-transparent to-transparent opacity-80" />
      </div>
      ...
      <div className="absolute right-[-25%] bottom-[3%] w-[650px] h-[650px] z-1 pointer-events-none opacity-20 hidden lg:block transition-all duration-700">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-l from-[#060111] via-transparent to-transparent opacity-80" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl py-12">
        ...
        <div className="text-center mb-4 flex flex-col items-center">
          {/* Logo size slightly reduced and margin tightened */}
          <div className="mb-2 animate-fade-in">
            <Logo className="h-9 w-9 text-amber-600 opacity-90" />
          </div>

          {/* Orange Subtitle - Smaller text and margin */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <Link href="/auth/signup/customer" className="group">
            <div className="h-full min-h-[350px] relative overflow-hidden rounded-[32px] border border-white/5 bg-white/[0.02] backdrop-blur-3xl p-8 flex flex-col items-center text-center transition-all duration-500 hover:border-purple-500/50 hover:bg-white/[0.04] hover:shadow-[0_0_40px_rgba(168,85,247,0.15)]">
              <div className="mb-6 relative flex items-center justify-center">
                ...
                <div className="relative w-25 h-25 group-hover:scale-110 transition-transform duration-300">
                  <Image
                    src={buyerImg}
                    alt="Customer Icon"
                    fill
          ...
          {/* Card 2: Manufacturer (Using sellerImg) */}
