...
function Section({ title, desc, children, className = "" }) {
  return (
    <div className={`bg-white/[0.03] border-2 border-purple-500/30 rounded-[2.5rem] p-8 relative overflow-hidden group hover:border-purple-500/50 transition-all duration-500 ${className}`}>
            ...
            <div className="relative h-40 bg-white/5 rounded-3xl overflow-hidden border border-white/10 group/banner">
              {bannerLoading ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-20">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">No banner active</p>
                </div>
              )}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex-1 flex items-center gap-6 p-6 bg-white/5 border border-white/10 rounded-3xl">
              ...
              <div className="flex flex-col gap-3">
                <p className="text-[10px] text-white/30 font-bold leading-relaxed uppercase tracking-tight">Square logo recommended (512x512)</p>
...
=======
        ...
        desc="Update your authentication parameters to maintain security."
>>>>>>> origin/FasihaUiBranch
      >
        <form onSubmit={handleSubmit} className="space-y-8">
          <Alert type="error" message={error} />
          {saved && (
...
=======
            <Alert type="success" message="Security credentials synchronized successfully." />
          )}
      ...
      {isVerified ? (
        <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-[2rem] p-6 flex items-center gap-6 backdrop-blur-md">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 mt-1.5 font-medium leading-relaxed">
              Your manufacturing credentials have been synchronized and validated by the Craftit network authority.
            </p>
          </div>
        </div>
      ) : (
        <div className="bg-amber-500/10 border border-amber-500/20 rounded-[2rem] p-6 flex items-center gap-6 backdrop-blur-md">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-500/20 shrink-0">
            <span className="material-symbols-outlined text-white text-2xl font-black">pending</span>
          </div>
          <div>
            <p className="text-sm font-black text-white uppercase tracking-widest">
          ...
          {uploaded ? (
            <div className="py-12 text-center flex flex-col items-center">
              ...
              <p className="text-xs text-white/30 mt-2 font-medium max-w-xs">
                Our verification nodes will audit your documents within 1–3 business cycles.
              </p>
              <button
            ...
            <form onSubmit={handleUpload} className="space-y-8">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  >
                    <option value="business_license" className="bg-[#050507]">Business License</option>
                    <option value="tax_registration" className="bg-[#050507]">Tax Registration</option>
                    <option value="certification" className="bg-[#050507]">Industry Certification (ISO, etc.)</option>
                    <option value="identity" className="bg-[#050507]">Owner Identity Document</option>
                    <option value="insurance" className="bg-[#050507]">Insurance Certificate</option>
                    <option value="bank_verification" className="bg-[#050507]">Bank Verification</option>
                    <option value="other" className="bg-[#050507]">Other Metadata</option>
                  </select>
                  <span className="absolute right-5 top-1/2 -translate-y-1/2 material-symbols-outlined text-white/20 pointer-events-none transition-transform group-hover:translate-y-[-40%]">expand_more</span>
                </div>
              </div>
              <div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-20 space-y-10">
        {!isVerified && (
          <div className="flex justify-end">
            ...
            >
              <span className="material-symbols-outlined text-sm font-black animate-pulse">warning</span>
              Identity Synchronization Required
            </button>
          </div>
        )}
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-white/35 font-medium">
            Manage your network identity, security protocols, and verification status.
          </p>
        </div>
